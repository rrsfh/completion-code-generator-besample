...
function submitForm(participantID, completionCode) {
    ...
    var googleSheetURL = 'https://script.google.com/macros/s/AKfycbwCbOhSt-oF2GS8hdSZ2WSiu7sxagU8TIOJM3noilSkFkqwqw_YWQz6BkSW-68uJDCv/exec';
...
if (participantID) {
    var n1 = 4968; // The hard-coded number
